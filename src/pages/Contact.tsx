      ...
      >
        ...
        <div className="section-container relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 tracking-tight text-slate-800" style={{ letterSpacing: '-0.02em' }}>
              {t("contact.title")}
            </h1>
            <p className="text-lg md:text-xl leading-relaxed mb-10 text-slate-600">
              {t("contact.subtitle")}
            </p>

            <div 
              className="rounded-2xl border p-8 md:p-10 shadow-lg text-center transition-all duration-500 backdrop-blur-sm"
              style={{
