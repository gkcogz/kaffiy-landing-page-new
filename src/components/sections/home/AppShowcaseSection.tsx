...
function PhoneMockup({ 
  ...
  return (
    <div 
      className="flex flex-col items-center gap-4 group transition-all duration-500 ease-out"
      style={{
    ...
    >
      <div 
        className="relative rounded-[2.5rem] p-[10px] transition-all duration-700 bg-gradient-to-br from-slate-600 via-slate-700 to-slate-800"
        style={{ 
    ...
    >
      ...
      <div className="section-container relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* 3D Phone Composition - Single Row with Mode Switch */}
          <div 
            className="relative flex items-center justify-center min-h-[600px] md:min-h-[700px]"
